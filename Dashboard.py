...
def mostrar_ayuda():
    print("\n--- Menú de Ayuda ---")
    print("1 - Ver el código de un script.")
    print("2 - Ejecutar un script seleccionado.")
    print("0 - Regresar al menú principal.")
    print("9 - Regresar al submenú anterior.")
    print("\nUsa las opciones indicadas por los números para navegar entre las unidades, subcarpetas y scripts.")
...
def mostrar_menu():
    ...
    while True:
        ...
        print("h - Ayuda")
        # Nueva opción de ayuda

        for key in unidades:
            print(f"{key} - {unidades[key]}")
        print("0 - Salir")

        eleccion_unidad = input("Elige una unidad o 'h' para ver la ayuda, '0' para salir: ")
